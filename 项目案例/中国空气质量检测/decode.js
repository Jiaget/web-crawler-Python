...
(function () {
  ...
  var _L = function (data) {
    data = AES.decrypt(data, "apAteRdhDd5i5n74", "bN8izWwuwRjjA0pH");
    data = DES.decrypt(data, "hY8XWvmotJ7yhyBV", "xCYtuanHBbJFWlKg");
    data = BASE64.decrypt(data);
    return data;
  };

  var _M = function (method, object, callback, period) {
  ...
  var _N = function (text) {
    var b = new Base64();
    return b.encode(text);
  };

  var _O = function (text) {
    var b = new Base64();
    return b.decode(text);
  };

  var _P = function (text, key, iv) {
  ...
  var _T = function (name, value) {
    var text = JSON.stringify(value);
    text = BASE64.encrypt(text);
    text = AES.encrypt(text, "emhlbnFpcGFsbWtleQ==", "emhlbnFpcGFsbWl2");
  ...
  var _V = function (name) {
    var text = localStorage.getItem(name);
    var result = null;

    if (text) {
      text = AES.decrypt(text, "emhlbnFpcGFsbWtleQ==", "emhlbnFpcGFsbWl2");
  ...
  var _X = function (method, obj) {
    ...
    var param = {
      ...
      object: obj,
      secret: hex_md5(appId + method + timestamp + clienttype + JSON.stringify(_e(obj)))
    };
    param = BASE64.encrypt(JSON.stringify(param));
    return param;
  };

  _$0.getDataFromLocalStorage = _J;
  _$0.ObjectSort = _K;
  _$0.dX506x9jVK3vuMMhoz6ZXx = _L;
  _$0.sJwf3VwkSgqmf0Ddr92K = _M;
  _$0.pNg63WJXHfm8r = void 0;
  _$0.localStorageUtil = void 0;
  _$0.AES = void 0;
  _$0.DES = void 0;
  _$0.BASE64 = void 0;
  _$0.BASE64 = {
  ...
  _$0.localStorageUtil = {
    save: _T,
    check: _U,
    getValue: _V,
    remove: _W
  };
  _$0.pNg63WJXHfm8r = _X;
}).call(this);
